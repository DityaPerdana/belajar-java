        ...
        while (true) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    if (nomor >= 1 && nomor <= 99) {
                        if (stokBarang[nomor - 1] > 0) {
                            totalHarga += hargaBarang[nomor - 1];
                            daftarBelanja.add(namaBarang[nomor - 1]);
                            stokBarang[nomor - 1]--;
                            System.out.println("Barang " + namaBarang[nomor - 1] + " telah ditambahkan ke keranjang.");
                        } else {
                            System.out.println("Stok barang " + namaBarang[nomor - 1] + " habis!");
                        }
                    } else {
